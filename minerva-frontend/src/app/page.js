            ...
            <div className=" w-[100vw]  relative z-10 bg-white">
                ...
                <div className="w-[85%] mx-auto">
                    <div className="relative md:min-h-[24rem]  flex m-0 p-0  flex-col">
                        <div className="flex md:flex-row flex-col w-[100%] md:mt-[7rem] mt-[4rem]">
                            ...
                            <div className=" h-auto font-jakarta text-justify font-bold text-black xl:text-[1.6rem] md-lg:text-[1.4rem] sm:text-[1.3rem] text-[1.1rem] w-[100%] flex flex-col justify- mx-auto">
                                <p className="mb-3">
                                    ...
                                    Engineering, NIT Calicut offers
                        ...
                        <div className="flex h-full items-center flex-col md-lg:flex-row">
                            ...
                            <div className="md-lg:w-[72%] w-[100%] flex items-center justify-between">
                                <p className="w-[100%] md-lg:w-[90%] text-black font-jakarta font-bold text-justify xl:text-[1.6rem] md-lg:text-[1.3rem] sm:text-[1.3rem] text-[1.1rem] md-lg:mt-3">
                                    ...
                                    knowledge- theory and practical - in the
                                    discipline of computing and the ability to
                                    apply the knowledge to the benefit of the
                                    society at large.
                                </p>
                            </div>
                    ...
                    <div className="flex relative flex-col ">
                        ...
                        <div className=" font-jakarta font-bold text-justify md:mr-[2rem] lg:mr-[0rem] flex justify-center items-center xl:text-[1.6rem] md-lg:text-[1.4rem] sm:text-[1.3rem] text-[1.1rem]">
                            <p className="">
                                From its inception about a century ago,
                                computing has become the defining technology of
                                our age. The study of computing is the study of
                                the process of abstraction and its power, the
                                practice of design and implementation,
                                mathematical theory of computation and its
                                implications.
                            </p>
                        </div>
                        ...
                        <div className="text-black font-jakarta font-bold text-justify md:mr-[2rem] lg:mr-[0rem] flex justify-center items-center xl:text-[1.6rem] md-lg:text-[1.4rem] sm:text-[1.3rem] text-[1.1rem] ">
                            <p className="pb-10">
                                Undergraduate programme in Computer Science and
                                Engineering started in the year 1985 in the then
                                Electrical Engineering Department. The
                                Department of Computer Science and Engineering
                                (CSE) was formally established as an independent
                                entity in the year 1997 as a result of
                                trifurcation of the Department of Electrical
                                Engineering.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="w-[88.5%] mx-auto">
                        ...
                        <div className="relative text-white font-jakarta  text-justify  md:mr-[2rem] lg:mr-[0rem] xl:text-[1.6rem] md:text-[1.4rem] sm:text-[1.3rem] text-[1.1rem] ">
                            ...
                            <p className="text-left xl:pt-10 lg:pt-4 lg:text-justify xl:text-[1.6rem] md-lg:text-[1.4rem] sm:text-[1.3rem] text-[1.1rem] mb-[2rem] hidden sm-md:block my-auto">
                                ...
                                Science and Engineering started in 1998. The
                                two-year M.Tech. programme in Computer Science
                                and Engineering (Information Security) started
                                in 2006. The two-year M.Tech. programme in
                                Computer Science and Engineering (Artificial
                                Intelligence and Data Analytics) started in
                                2023. PhD programme started in 2002.
                            </p>
                        </div>
                        {/* For Mobile */}
