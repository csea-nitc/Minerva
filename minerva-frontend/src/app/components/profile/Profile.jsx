        ...
        <>
            <div className="font-verdana relative h-[50rem] md:flex m-0 p-0 overflow-hidden flex">
                ...
                <div className="flex flex-col md:flex-row h-[100%] w-[100%] ">
                    ...
                    <div className="sm:h-[100%] h-[60%] text-black md:text-[1.8rem] sm:text-[1.6rem] text-[1.3rem] xl:w-[60%] lg:w-[65%] md:w-[68%] sm:w-[80%] w-[85%]  flex flex-col justify-center text-justify sm:gap-[5rem] gap-[1rem]  md:ml-[5.5rem] sm:ml-[5rem] ml-[2.5rem]">
