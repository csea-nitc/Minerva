  ...
  return (
    <div className="relative w-[100%] h-[100vh]  m-0 p-0 box-border ">
      ...
      >
        ...
        <p className="text-white font-saira max-400:text-3xl max-400:mb-[40vh] text-4xl sm:text-6xl font-extrabold z-10 max-w-[80%] sm:max-w-[600px] lg:max-w-[800px] p-auto mb-[35vh]  sm:mb-20">
          DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING
        </p>
        <div className="bg-[#FFFBF2] pr-8 sm:px-0 text-left sm:min-w-[500px]  rounded-2xl sm:rounded-b-none    absolute bottom-10 sm:bottom-0   sm:right-auto z-10 ">
