...
const Hero = ({ props }) => {
  return (
    <div className="w-[100%] h-[100vh] m-0 p-0 box-border">
      ...
      >
        <p className="text-white font-saira text-4xl md:text-5xl lg:text-6xl font-extrabold w-[65%] p-auto relative top-14">
          DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING
        </p>
        <div className="bg-[#FFFBF2] min-[400px]:w-[40%] w-[45%] md:w-[60%] rounded-2xl mt-8 relative top-20 min-[450px]:top-28 min-[500px]:top-28 min-[600px]:top-36 md:top-48 lg:top-56 xl:top-60 2xl:top-64 ">
