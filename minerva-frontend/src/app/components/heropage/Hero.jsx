...
const Hero = () => {
  return (
    <div className='w-[100vw] h-[100vh] m-0 p-0 box-border'>
        <div className='relative container-fluid w-[100%] h-[100%] flex flex-col text-center justify-center items-center bg-cover bg-center overflow-hidden pt-5' style={{backgroundImage:"url('./Hero/hero-bg.png')"}}>
            ...
            <div className='bg-[#FFFBF2] min-[400px]:w-[40%] w-[45%] md:w-[60%] rounded-2xl p-5 md:mb-4 relative top-12 md:top-36' >
                <div className='flex flex-col md:flex-row justify-around md:p-5 w-[100%] text-[#812981] font-teko md:text-left'>
                    <div className='flex flex-col justify-center md:w-[33%] border-b md:border-b-0 md:border-r-4 border-[#DEBDDD] md:mr-3 mt-3 pb-3 md:pb-0 md:pr-3'>
                        ...
                        <p className='text-[#696969] text-left text-md md:text-lg md:w-[85%]'>The quick brown fox and he likes carrots</p>
                    </div>
                    <div className='flex flex-col justify-center md:w-[33%] border-b md:border-b-0 md:border-r-4 border-[#DEBDDD] md:mr-3 mt-3 pb-3 md:pb-0 md:pr-3'>
