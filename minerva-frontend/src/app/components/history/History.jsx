    ...
    return (
        <div className="flex relative flex-col pb-6">
            ...
            <div className="flex items-center justify-center">
                <div className="text-center text-[#800080] font-saira lg:text-[11.5rem] xl-lg:text-[12rem] md:text-[10rem] sm:text-[8rem] text-[6rem] md:w-[45rem] sm:h-[10.75rem] flex justify-center items-center font-bold flex-grow lg:flex-grow-0 md:mb-[4rem]">
                    HISTORY
                </div>
            </div>
            <div className="text-black font-mont w-[89%] font-bold text-justify md:mr-[2rem] lg:mr-[0rem] flex justify-center items-center xl:text-[1.7rem] md:text-[1.5rem] sm:text-[1.3rem] text-[1.1rem] md:ml-[3rem] sm:ml-[3rem] ml-[1.6rem]">
                <p className="w-[90%]">
            ...
            <div className="relative flex justify-end font-saira md:mt-[15rem] mt-[8rem] lg:mt-[5rem] mb-[5rem] md:ml-[5rem] md:mr-[13rem] w-[90%] ml-[2.5rem] sm:ml-[3.5rem]">
                {/** Slide Left (for lg+) **/}
            ...
            <div className="text-black w-[89%] text-justify font-mont font-bold md:mr-[2rem] lg:mr-[0rem] flex justify-center items-center xl:text-[1.7rem] md:text-[1.6rem] sm:text-[1.4rem] text-[1.2rem] md:ml-[3rem] sm:ml-[3rem] ml-[1.6rem]">
                <p className="w-[95%]">
