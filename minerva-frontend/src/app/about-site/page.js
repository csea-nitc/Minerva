    ...
    return (
        <div className="pt-10 mt-10 lg:px-[20vw] md:px-[15vw] px-[10vw] w-[100vw]">
            ...
            <p>
                ...
                and Engineering, NIT Calicut on the Internet.
            </p>
            <p>
                ...
                quality to the world. We invite contributions from the members
                of the <strong>CSED community of NIT Calicut</strong> to help us
            ...
            <ol className="list-decimal pt-6 pb-6">
                ...
                <li className="pb-2">
                    ...
                    things. We will try to make the changes in appropriate
                    amount of time.
                </li>
                <li className="">
                    <strong>Ideas and Suggestions</strong> for the improvement
                    of the website are also welcome.
                </li>
            </ol>
            <p>
            ...
            <p>
                ...
                implementation details which will appear on this page when it is
                ready.
            </p>
        </div>
        </div>
