...
export default function accessibility() {
    return (
        <div>
            <ImageHero title={"Accessibility Statement"} font={"4em"} />
        <div className="content-div pt-10 max-w-6xl mx-auto px-6 w-[100vw]">
            ...
            <div className="font-mont pt-6 pb-6">
                <p className="md:text-lg">
                    ...
                    ability. It is being built with an aim to provide maximum{" "}
                    <span className="font-bold">
                        accessibility and usability
                    </span>{" "}
                    to its visitors. As a result, this website will be viewable
                    from a variety of devices, such as web-enabled mobile
                    devices, wap phones, PDAs, and so on.
                </p>
                <p className="md:text-lg pt-6">
                    We are putting in our best efforts to ensure that all
                    information on this website is accessible to people with
                    disabilities.&nbsp;For example, a user with visual
                    disability will be able to access this website using
                ...
                <p className="md:text-lg pt-6">
                    ...
                    distinctio nobis accusamus excepturi accusantium, dolores
                    eaque nihil ipsum, modi nostrum numquam, rerum dolore
                    reprehenderit! Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Molestias et maxime cupiditate atque
                    soluta, quibusdam, eligendi totam culpa placeat accusamus
                    fuga beatae ipsa iure facilis adipisci sequi, nobis ab
                    autem. Rem amet modi laudantium quae iste, quis
                    consequuntur. Itaque excepturi deserunt eveniet id
                    repellendus eos exercitationem, nulla ut ullam consequuntur
                    natus repellat molestias quo nam officia enim laboriosam
                    nemo minus! <br />
