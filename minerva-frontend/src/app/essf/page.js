                ...
                <div className="sm:w-[65%] w-[85%] mx-auto py-10">
                    <div className="font-jakarta pt-6 pb-6 ">
                        ...
                        <p className="md:text-lg pt-2">
                            ...
                            needs of <b>full time B.Tech CSE students</b> who
                            are currently on rolls. The funds are provided as a
                        ...
                        <p className="md:text-lg pt-2">
                            ...
                            they are in a better financial situation. This fund
                            is for the students and managed primarily by the
                        ...
                        <div className="md:text-lg pt-2">
                            Any full time B.Tech CSE student of NITC in need of
                            funds is requested to contact the following student
                            representatives by email:
                            <div className="pt-6 pb-6">
                                {studentRepresentatives.map(
                                    (representative) => (
                        ...
                        <p className="md:text-lg pt-2">
                            ...
                            application form, the representatives will make the
                            decision to approve the amount, if necessary, after
                        ...
                        <p className="md:text-lg pt-2">
                            ...
                            transactions. If you wish to repay the loan /
                            contribute to this fund, online transfers may be
                            made to the following account. There is no tax
